...
const (
	expectedPrettySD = `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600">
  <line x1="50" y1="20" x2="50" y2="480" style="stroke:#888;"/>
  <line x1="150" y1="20" x2="150" y2="480" style="stroke:#888;"/>
  <line x1="250" y1="20" x2="250" y2="480" style="stroke:#888;"/>
  <line x1="350" y1="20" x2="350" y2="480" style="stroke:#888;"/>
  <line x1="450" y1="20" x2="450" y2="480" style="stroke:#888;"/>
  <line x1="550" y1="20" x2="550" y2="480" style="stroke:#888;"/>
  <line x1="650" y1="20" x2="650" y2="480" style="stroke:#888;"/>
  <g class="systems" transform="translate(50,20)">
    <rect x="-40" y="0" width="80" height="40" style="fill:#CCC;"/>
  </g>
  ...
  <line x1="50" y1="100" x2="250" y2="100" marker-end="url(#end)" style="stroke:black;"/>
  <text>
    From A to C
  </text>
  <line x1="250" y1="150" x2="350" y2="150" marker-end="url(#end)" style="stroke:black;"/>
  <text>
    From C to D
  </text>
  <line x1="350" y1="200" x2="450" y2="200" marker-end="url(#end)" style="stroke:black;"/>
  <text>
    From D to E
  </text>
  <line x1="450" y1="250" x2="350" y2="250" marker-end="url(#end)" style="stroke:black;"/>
  <text>
    From E to D
  </text>
  <line x1="350" y1="300" x2="650" y2="300" marker-end="url(#end)" style="stroke:black;"/>
  <text>
    From D to G
  </text>
  <line x1="650" y1="350" x2="350" y2="350" marker-end="url(#end)" style="stroke:black;"/>
  <text>
    From G to D
  </text>
  <line x1="350" y1="400" x2="250" y2="400" marker-end="url(#end)" style="stroke:black;"/>
  <text>
    From D to C
  </text>
  <line x1="250" y1="450" x2="50" y2="450" marker-end="url(#end)" style="stroke:black;"/>
  <text>
    From C to A
  </text>
...
func TestSequenceDiagram(t *testing.T) {
	...
	for i := range classes {
		...
		s.G().Transform(svgTD.Translate(x, yPadding)).
			Class("systems").
			Rect().
	...
	for i, c := range classes {
		...
		s.G().
			Transform(svgTD.Translate(x, yPadding)).
			Class("labels").
	...
	for i, m := range messages {
		...
		s.G().Transform(svgTD.Translate(xPos, yPos)).
			Class(m.message).
